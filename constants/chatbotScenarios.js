...
import { addChatbotUserMessageAction, changeChatbotCurrentScenarioIdAction } from '../redux/actions/chatbotActions';

const SELLER_SCENARIOS = {
    'SELLER-1': {
        id: 'SELLER-1',
        text: 'Добавьте фотографии квартиры. Не скромничайте, чем больше фотографий, тем лучше',
        controls: [
            (props) => {
                return (
                    <Button
                        onPress={() => {
                            ...
                            store.dispatch(addChatbotUserMessageAction({
                                text: 'Добавить'
                            }));
                ...
                return (
                    <Button 
                        onPress={() => {
                            ...
                            store.dispatch(changeChatbotCurrentScenarioIdAction('END_OF_SCENARIO'));
                        }}
...
const FIRST_TIME_SCENARIOS = {
                ...
                return (
                    <Button
                        onPress={() => {
                            ...
                            store.dispatch(changeChatbotCurrentScenarioIdAction('FIRST_TIME-2'));
                        }}
                ...
                return (
                    <Button
                        onPress={() => {
                            ...
                            store.dispatch(changeChatbotCurrentScenarioIdAction('FIRST_TIME-4'));
                        }}
                        title='Готово'
                        {...props}>
                    </Button>
    ...
    'FIRST_TIME-5': {
        id: 'FIRST_TIME-5',
        text: 'У нас все немного иначе чем обычно бывает. Вы ищите квартиру, и одновременно хозяин квартиры ищет вас. Чтобы показать вам результаты поиска нам нужно узнать что вы ищите и кто вы сами. Готовы?',
        controls: [
            (props) => {
                return (
                    <Button
                        onPress={() => {
                            ...
                            store.dispatch(changeChatbotCurrentScenarioIdAction('FIRST_TIME-6'));
                        }}
                        title='Спрашивай'
                        {...props}>
                    </Button>
                ...
                return (
                    <Button
                        onPress={() => {
                            ...
                            store.dispatch(changeChatbotCurrentScenarioIdAction('FIRST_TIME-7'));
                        }}
                        title='Миша'
                        {...props}>
                    </Button>
                ...
                return (
                    <Button
                        onPress={() => {
                            ...
                            store.dispatch(changeChatbotCurrentScenarioIdAction('FIRST_TIME-8'));
                        }}
                        title='31'
                        {...props}>
                    </Button>
                ...
                return (
                    <Button 
                        onPress={() => {
                            ...
                            store.dispatch(changeChatbotCurrentScenarioIdAction('FIRST_TIME-1'));
                        }}
