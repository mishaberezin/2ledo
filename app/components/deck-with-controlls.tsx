...
class DeckWithControllsContainer extends Component {
  ...
  renderControls = () => {
    ...
    return (
      <Animated.View
        style={[style.controlsContainer, { opacity: this.controlsOpacity }]}
      >
        <TouchableOpacity
          style={[style.controlContainer, style.controlContainerLeft]}
        ...
        <TouchableOpacity
          style={[style.controlContainer, style.controlContainerRight]}
          onPress={this.hadleControlPress}
        >
          <Ionicons
  ...
  render() {
    ...
    const cardStyle = [this.getCardStyle(), style.card];

    if (cardOpened) {
      cardStyle.push(style.cardStatic);
    }
        ...
        <View>
          {items
            .map((card, i) => {
              ...
              return (
                <Animated.View style={style.card} key={i}>
...
export const DeckWithControlls = withStyles(DeckWithControllsContainer, () => ({
  container: {
    display: 'flex',
    flexDirection: 'row',
    flex: 1,
